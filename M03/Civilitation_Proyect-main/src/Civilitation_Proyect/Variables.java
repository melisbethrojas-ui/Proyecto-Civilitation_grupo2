...
public interface Variables {
    ...
    public int MANA_COST_MAGICTOWER = 50;
    ...
    // Costes de mejora tecnológica
    int IRON_COST_TECH_DEFENSE = 100;
    int IRON_COST_TECH_ATTACK = 120;

    // Estadísticas Magician


    int PLUS_ARMOR_MAGICIAN_BY_TECHNOLOGY = 5;

    // Estadísticas Priest
    int ARMOR_PRIEST = 1000;
    int BASE_DAMAGE_PRIEST = 100;

    int PLUS_ARMOR_PRIEST_BY_TECHNOLOGY = 5;
    int PLUS_ATTACK_PRIEST_BY_TECHNOLOGY = 5;

    public final int ARMOR_MAGICIAN = 3000;
    ...
    public final int UPGRADE_BASE_FRAME_TECHNOLOGY_IRON_COST = 2000; // Ya la tienes
    public final int PERCENTAGE_UPGRADE_TECH_COST = 10; // Falta este
}
